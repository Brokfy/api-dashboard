...
Order By Aseguradora, TipoRegistro, FechaInicio, NumeroPoliza;", data.FechaInicio, data.FechaFin, data.IdAseguradora == null ? 0 : data.IdAseguradora, data.IdTipoPoliza == null ? 0 : data.IdTipoPoliza);
            ...
            {
                "FacturacionTotal" => _context.ReporteFacturacionTotales.FromSqlRaw(Where).ToList(),
                "Comisiones" => _context.ComisionActualModels.FromSqlRaw("Select * From brokfy_dev.vwAseguradorasComisionesActuales").ToList(),
                "Siniestros" => _context.ComisionActualModels.FromSqlRaw("Select * From brokfy_dev.vwAseguradorasComisionesActuales").ToList(),
